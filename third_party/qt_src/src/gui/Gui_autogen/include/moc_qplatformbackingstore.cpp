...
static constexpr auto qt_meta_stringdata_CLASSQPlatformTextureListENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSQPlatformTextureListENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSQPlatformTextureListENDCLASS_t qt_meta_stringdata_CLASSQPlatformTextureListENDCLASS = {
    {
        QT_MOC_LITERAL(0, 20),  // "QPlatformTextureList"
        QT_MOC_LITERAL(21, 6),  // "locked"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "QPlatformTextureList",
    "locked",
