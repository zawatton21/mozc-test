...
static constexpr auto qt_meta_stringdata_CLASSQCommandLinkButtonENDCLASS = QtMocHelpers::stringData(
    "QCommandLinkButton",
    "description",
    "flat"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSQCommandLinkButtonENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSQCommandLinkButtonENDCLASS_t qt_meta_stringdata_CLASSQCommandLinkButtonENDCLASS = {
    {
        QT_MOC_LITERAL(0, 18),  // "QCommandLinkButton"
        QT_MOC_LITERAL(19, 11),  // "description"
        QT_MOC_LITERAL(31, 4)   // "flat"
    },
    "QCommandLinkButton",
    "description",
    "flat"
