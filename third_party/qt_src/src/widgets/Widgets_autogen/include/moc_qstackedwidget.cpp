...
static constexpr auto qt_meta_stringdata_CLASSQStackedWidgetENDCLASS = QtMocHelpers::stringData(
    "QStackedWidget",
    "currentChanged",
    "",
    "widgetRemoved",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSQStackedWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSQStackedWidgetENDCLASS_t qt_meta_stringdata_CLASSQStackedWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "QStackedWidget"
        QT_MOC_LITERAL(15, 14),  // "currentChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 13),  // "widgetRemoved"
